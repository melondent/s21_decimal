...
void zero_all_bits(s21_decimal *d) {
    if (d) {
        d->bits[0] = 0;
        d->bits[1] = 0;
        d->bits[2] = 0;
...
int handle_scales_equality(s21_decimal *value_1, s21_decimal *value_2, int *final_scale) {
